...
PM_START_TEXT = \
    """
Hi {}, my name is {}! I'm a Telegram bot made by @A_L_Satya to help tc groups and keep track of bugs and suggestions sent there.

To see a list of my commands use `/help`.

I'm not made to be used on any group, so dont add me to any other.
"""
