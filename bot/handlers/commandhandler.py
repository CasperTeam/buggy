...
__COMMANDS__: List[BotCommand] = [BotCommand("start", "Starts this bot/Displays start message!"),
                                  ...
                                  BotCommand("wolfbothelp", "about wolfbothelp"),
                                  BotCommand("playvoicechat", "about Playvoicechat"),
                                  BotCommand("international_chattings_english", "about international_chattings_english"),
                                  BotCommand("snow_chatting", "about snow_chatting"),
                                  BotCommand("pmpermit", "about Pmpermit"),
                                  BotCommand("tcbotsbugs", "about tcbotsbugs"),
                                  BotCommand("Music_Database_937", "about Music_Database_937"),]
